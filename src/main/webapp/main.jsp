		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				...
				<div class="d-flex align-items-center">
					...
					<% } else { %>
						<a href="user/login.jsp" class="btn btn-sm btn-light text-secondary fw-bold me-2">로그인</a>
					<% } %>
				</div>
			</div>
		</div>
				...
				<div class="col-md-4 mb-4">
					<div class="card shadow-sm border-0 h-100">
						<div class="card-body text-center py-5">
							...
							<a href="${pageContext.request.contextPath}/physicalInfo" class="btn btn-custom px-4 mt-2">확인하기</a>
						</div>
					</div>
				</div>
			</div> 
		<% } else { %>
			<div class="p-5 mb-4 bg-white rounded-3 shadow-sm text-center" style="margin-top: 50px; border-radius: 15px;">
				<div class="container-fluid py-5">
					<h1 class="display-5 fw-bold text-secondary mb-3">🏋️‍♂️ Workout Tracker</h1>
					<p class="col-md-8 fs-5 text-muted mx-auto">당신의 일일 운동 기록, 보충제 재고, 인바디 변화를 한곳에서 스마트하게 관리하세요.</p>
					<hr class="my-4 mx-auto" style="width: 60%;">
					<p class="text-muted">로그인 후 스마트한 대시보드 기능을 이용하실 수 있습니다.</p>
					<a class="btn btn-custom btn-lg px-5 mt-2" href="user/login.jsp" role="button" style="border-radius: 20px;">지금 시작하기</a>
				</div>
			</div>
		<% } %>
	</div>
